	...
	private static EventHubClient receiveMessages(final String partitionId)
	 {
	   ...
	   try {
	     ...
	     client = EventHubClient.createFromConnectionStringSync(testGUI.getConnectionString());
		   ...
		   JOptionPane.showMessageDialog(null,"Failed  to create client: " + e.getMessage(),"ERROR",JOptionPane.WARNING_MESSAGE);
	   ...
	   try {
	       ...
	       Instant.EPOCH).thenAccept(new Consumer<PartitionReceiver>()
	     {
	       public void accept(PartitionReceiver receiver)
	       {
	           ...
	           while (true) {
	             ...
	             if (receivedEvents != null)
	             {
	               for(EventData receivedEvent: receivedEvents)
	               {
	                 ...
	                 JSONObject obj = new JSONObject(new String(receivedEvent.getBody(),Charset.defaultCharset()));
	                 String d = obj.getString("device");
	                 //long a = obj.getLong("time");
	                 long a = receivedEvent.getSystemProperties().getEnqueuedTime().toEpochMilli();
	         ...
	         {
	        	 JOptionPane.showMessageDialog(null,"Failed to receive messages: " + e.getMessage(),"ERROR",JOptionPane.WARNING_MESSAGE);
	         }
	       }
	     });
	   }
	   ...
	   {
		   JOptionPane.showMessageDialog(null,"Failed  to create receiver: " + e.getMessage(),"ERROR",JOptionPane.WARNING_MESSAGE);
	   }
