...
public class TestReceiver {
								...
								while (true) {
									...
									if (receivedEvents != null) {
										for (EventData receivedEvent : receivedEvents) {
											...
											System.out.println(String.format("| Device ID: %s", receivedEvent
	...
	// "HostName=rivtec.azure-devices.net;DeviceId=testDevice;SharedAccessKey=a3nFHxz3GDigj96JCTui03VMftQn5Q8JozETaUq2IKU=";
