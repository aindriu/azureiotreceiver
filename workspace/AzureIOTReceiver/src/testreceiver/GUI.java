...
public class GUI  {
	...
	public void init()
	{
		...
		connString = new JTextField("Endpoint=sb://iothub-ns-riv-144717-4d6a93f30c.servicebus.windows.net/;EntityPath=riv;SharedAccessKeyName=iothubowner;SharedAccessKey=lkqf7Ycx56OlZGPg0YzYhF8S0u+YBbnhCV/ohHXmBvM=", 20);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
				    ...
				    writer.close();
		        	 ...
		        	 JOptionPane.showMessageDialog(null,"IO Issue: " + e1.getMessage(),"ERROR",JOptionPane.WARNING_MESSAGE);
		...
		/*
		Object[][] data = {
			    {"23434234", "34543534", "teststring"},
			    {"34432432", "43545435", "anotherstring"},
			    {"35543535", "34435454", "yetanother"},
			};
		*/
		Object[][] data = { };
